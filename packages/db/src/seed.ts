...
async function seed() {
  ...
  const entries = [
    ...
    },
    {
      ...
      timestamp: daysAgo(3),
      author: "C/E Jon Eaton",
      title: "Emergency Lighting and Power Test",
      body: "Weekly emergency lighting and power test. All emergency lights operational throughout vessel. Emergency generator ran under load. Transfer switch functioned normally. Logged per 46 CFR 78.73.",
    },
    {
      vesselId: vessel.id,
      entryType: "inspection" as const,
      timestamp: daysAgo(94),
      author: "Bob Jarvis",
      title: "Fire Extinguisher Annual Inspection",
      body: "Annual inspection of all portable fire extinguishers by certified technician. All units weighed, gauges checked, seals intact. Tags updated. Two CO2 units recharged.",
    },
    {
      vesselId: vessel.id,
      entryType: "maintenance" as const,
      timestamp: daysAgo(121),
      author: "Bob Jarvis",
      title: "Inflatable Liferaft Annual Servicing",
      body: "Both inflatable liferafts removed and serviced at USCG-approved facility. Inflation test passed, CO2 cylinders weighed, survival equipment inspected and replaced as needed. Recertified for 12 months.",
    },
    {
      vesselId: vessel.id,
      entryType: "inspection" as const,
      timestamp: daysAgo(412),
      author: "Capt. Cevan Lesieur",
      title: "Drydock Examination",
      body: "Vessel drydocked at BAE Systems San Francisco. Hull examined by USCG inspector — internal structural exam completed. Sea valves overhauled, hull coated. Next drydock examination due in 5 years.",
    },
    {
      vesselId: vessel.id,
